...
public class BalanceUpdateHandler implements BankResponseHandler {
    private static final String TAG = "BalanceUpdateHandler";
    private final UartManager uartManager;

    public BalanceUpdateHandler(UartManager uartManager) {
    ...
    public void handle(BankResponse response) {
        BankHandlerSupport.runSafely(uartManager, response, TAG, () -> {
            ...
            Log.d(TAG, "Balance Update Response Success");
