...
public class MoneyLoadByAccountHandler implements BankResponseHandler {
    private static final String TAG = "MoneyLoadByAccountHandler";
    private final UartManager uartManager;

    public MoneyLoadByAccountHandler(UartManager uartManager) {
    ...
    public void handle(BankResponse response) {
        BankHandlerSupport.runSafely(uartManager, response, TAG, () -> {
            ...
            Log.d(TAG, "Money Load by Account Response Success");
