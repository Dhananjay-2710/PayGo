...
public class SaleHandler implements BankResponseHandler {
    private static final String TAG = "SaleHandler";
    private final UartManager uartManager;

    public SaleHandler(UartManager uartManager) {
    ...
    public void handle(BankResponse response) {
        BankHandlerSupport.runSafely(uartManager, response, TAG, () -> {
            ...
            Log.d(TAG, "Sale Response Success");
