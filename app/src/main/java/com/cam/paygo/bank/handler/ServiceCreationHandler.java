...
public class ServiceCreationHandler implements BankResponseHandler {
    private static final String TAG = "ServiceCreationHandler";
    private final UartManager uartManager;

    public ServiceCreationHandler(UartManager uartManager) {
    ...
    public void handle(BankResponse response) {
        BankHandlerSupport.runSafely(uartManager, response, TAG, () -> {
            ...
            Log.d(TAG, "Service Creation Data Response Success");
            ...
            uartManager.serviceCreationSuccessResponse(
                    statusCode,
                    responseType,
                    message,
                    TranType,
