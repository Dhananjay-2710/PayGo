...
public class TransactionEnquiryHandler implements BankResponseHandler {
    private static final String TAG = "TransactionEnquiryHandler";
    private final UartManager uartManager;

    public TransactionEnquiryHandler(UartManager uartManager) {
    ...
    public void handle(BankResponse response) {
        BankHandlerSupport.runSafely(uartManager, response, TAG, () -> {
            ...
            Log.d(TAG, "Transaction Enquiry Response Success");
            ...
            uartManager.sendTransactionEnquiryResponse(
                    statusCode,
                    responseType,
                    message,
                    TranType,
